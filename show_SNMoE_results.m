function show_SNMoE_results(x, y, SNMoE, klas, TrueStats)
...
if nargin>3
    ...
    ylim(yaxislim)
    hold off
    legend([h1, h4, h3(1), h5, h2(1)], 'data',['True mean',' (SNMoE)'],'True Experts', ...
        ['Estimated mean',' (SNMoE)'],'Estimated Experts',...
        'Location','SouthWest');
    legend('boxoff')
    figure,
    for k=1:K
    ...
    legend([h1, h2, h3(1), h4, h5(1)],'data', ['True mean',' (SNMoE)'], ....
        'True conf. regions',['Estimated mean',' (SNMoE)'], 'Estimated conf. regions',...
        'Location','SouthWest');
    legend('boxoff');
    xlabel('x'), ylabel('y');
    ylim(yaxislim)
    ...
    ylim(yaxislim)
    hold off
    legend([h1, h2(1), h3], 'data','SNMoE mean function','Estimated Experts',...
        'Location','SouthWest');
    legend('boxoff')
    figure,
    for k=1:K
